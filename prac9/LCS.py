...
ArchivoOriginal="FileOriginal3.txt"
ArchivoCopia="FileCopia3.txt"
...
porc = Porcentaje(len(CadenaArchivoOriginal),C[len(CadenaArchivoOriginal)][len(CadenaArchivoCopia)])

print("El archivo  :  "+ArchivoOriginal)
print("y el archivo : "+ArchivoCopia)

print("tienen "+str(porc )+" % de similidud" )
